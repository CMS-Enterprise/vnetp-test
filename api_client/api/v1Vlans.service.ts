...
export class V1VlansService {
     ...
     */
    public v1TiersTierIdVlansGet(requestParameters: V1TiersTierIdVlansGetRequestParams, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<Array<Vlan>>;
    public v1TiersTierIdVlansGet(requestParameters: V1TiersTierIdVlansGetRequestParams, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<Array<Vlan>>>;
    public v1TiersTierIdVlansGet(requestParameters: V1TiersTierIdVlansGetRequestParams, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<Array<Vlan>>>;
    public v1TiersTierIdVlansGet(requestParameters: V1TiersTierIdVlansGetRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public v1TiersTierIdVlansIdGet(requestParameters: V1TiersTierIdVlansIdGetRequestParams, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<Vlan>;
    public v1TiersTierIdVlansIdGet(requestParameters: V1TiersTierIdVlansIdGetRequestParams, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<Vlan>>;
    public v1TiersTierIdVlansIdGet(requestParameters: V1TiersTierIdVlansIdGetRequestParams, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<Vlan>>;
    public v1TiersTierIdVlansIdGet(requestParameters: V1TiersTierIdVlansIdGetRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
