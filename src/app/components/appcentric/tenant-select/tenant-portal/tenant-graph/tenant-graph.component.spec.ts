...
describe('TenantGraphComponent', () => {
  ...
  const mockPathTraceState: PathTraceState = {
    ...
    pathTraceData: {
      ...
      path: [
        { nodeId: 'tenant1', edgeId: 'edge1', cost: 0, isLastHop: false },
        { nodeId: 'fw1', cost: 1, isLastHop: true },
      ],
      isComplete: true,
      totalCost: 1,
  ...
  describe('Graph Loading', () => {
    ...
    it('should set loading state while loading graph', () => {
      mockTenantService.buildTenantFullGraph.mockReturnValue(of(mockGraph) as any);
