...
title = 'network-diagram';
  ...
  ngAfterContentInit() {
    ...
    .force('link', d3.forceLink().id((d: any) =>  d.id).distance(100).strength(0.001))
  ...
  drawGraph() {
    ...
    .enter().append('line')
      .attr("stroke", function(d) { return color('gray'); })
  ...
  let node = this.svg.append('g')
    ...
    node.append('image')
      .attr('xlink:href', function(d) { return ('assets/img/group' + d.group + '.png'); })
      .attr('width', 32)
      .attr('height', 32)
      .attr('x', - 16)
      .attr('y', - 16)
