...
@Component({
  selector: 'app-routing-rejection-reason-dialog',
  template: `
...
export class RoutingRejectionReasonDialogComponent {
  constructor(
    public dialogRef: MatDialogRef<RoutingRejectionReasonDialogComponent>,
