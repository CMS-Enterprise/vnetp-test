...
//     const networkObjects = [{ Name: 'Test' }, { Name: 'Test2' }] as Array<
//       NetworkObject
//     >;
...
//     const networkObjectGroups = [{ Name: 'Test' }, { Name: 'Test2' }] as Array<
//       NetworkObjectGroup
//     >;
//     const firewallRule = { Name: 'Allow Test2' } as FirewallRule;
...
//     const serviceObjects = [{ Name: 'Test' }, { Name: 'Test2' }] as Array<
//       ServiceObject
//     >;
//     const firewallRule = { Name: 'Allow Test2' } as FirewallRule;
...
//   it('should map destination service object', () => {
//     const serviceObjectGroups = [{ Name: 'Test' }, { Name: 'Test2' }] as Array<
//       ServiceObjectGroup
//     >;
//     const firewallRule = { Name: 'Allow Test2' } as FirewallRule;
...
//     const result = ObjectService.objectIsUnique(
//       uniqueObject,
//       uniqueObjects,
//       false,
//     );
...
//     expect(() => {
//       ObjectService.objectIsUnique(null, uniqueObjects);
...
//     expect(() => {
//       ObjectService.objectIsUnique(uniqueObject, null);
//     }).toThrowError('Null object or object collection.');
//   });
...
//     expect(() => {
//       ObjectService.objectIsUnique(uniqueObject, uniqueObjects);
