...
const openId: OidcClientSettings = {
  ...
  redirect_uri: 'https://10.151.14.74/callback',
  response_type: 'token',
  scope: 'openid profile',
  loadUserInfo: true,
  metadata: {
    issuer: 'https://cfs01-dc01.draas.cdsvdc.lcl/cfs/oauth/draasui',
    authorization_endpoint: 'https://cfs01-dc01.draas.cdsvdc.lcl/cfs/oauth/draasui/authorize',
    token_endpoint: 'https://10.151.14.74/cfs/oauth/draasui/tokenservice',
    userinfo_endpoint: 'https://10.151.14.74/cfs/oauth/draasui/userinfo',
  },
};
