...
export class V2AppCentricBridgeDomainsService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public createManyBridgeDomain(requestParameters: CreateManyBridgeDomainRequestParams, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<Array<BridgeDomain>>;
    public createManyBridgeDomain(requestParameters: CreateManyBridgeDomainRequestParams, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<Array<BridgeDomain>>>;
    public createManyBridgeDomain(requestParameters: CreateManyBridgeDomainRequestParams, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<Array<BridgeDomain>>>;
    public createManyBridgeDomain(requestParameters: CreateManyBridgeDomainRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        ...
        return this.httpClient.post<Array<BridgeDomain>>(`${this.configuration.basePath}/v2/app-centric/bridge-domains/bulk`,
