...
export class V2AppCentricContractsService {
     ...
     */
    public createManyContract(requestParameters: CreateManyContractRequestParams, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<Array<Contract>>;
    public createManyContract(requestParameters: CreateManyContractRequestParams, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<Array<Contract>>>;
    public createManyContract(requestParameters: CreateManyContractRequestParams, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<Array<Contract>>>;
    public createManyContract(requestParameters: CreateManyContractRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        ...
        return this.httpClient.post<Array<Contract>>(`${this.configuration.basePath}/v2/app-centric/contracts/bulk`,
