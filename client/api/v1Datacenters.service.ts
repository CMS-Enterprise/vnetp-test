...
export class V1DatacentersService {
     ...
     */
    public createManyDatacenter(requestParameters: CreateManyDatacenterRequestParams, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<Array<Datacenter>>;
    public createManyDatacenter(requestParameters: CreateManyDatacenterRequestParams, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<Array<Datacenter>>>;
    public createManyDatacenter(requestParameters: CreateManyDatacenterRequestParams, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<Array<Datacenter>>>;
    public createManyDatacenter(requestParameters: CreateManyDatacenterRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        ...
        return this.httpClient.post<Array<Datacenter>>(`${this.configuration.basePath}/v1/datacenters/bulk`,
