...
export class V2AppCentricSubjectsService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public createManySubject(requestParameters: CreateManySubjectRequestParams, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<Array<Subject>>;
    public createManySubject(requestParameters: CreateManySubjectRequestParams, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<Array<Subject>>>;
    public createManySubject(requestParameters: CreateManySubjectRequestParams, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<Array<Subject>>>;
    public createManySubject(requestParameters: CreateManySubjectRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        ...
        return this.httpClient.post<Array<Subject>>(`${this.configuration.basePath}/v2/app-centric/subjects/bulk`,
