...
import { WanFormChanges } from '../model/models';
...
export interface GetWanFormChangesWanFormRequestParams {
    id: string;
}
...
export class V1NetworkScopeFormsWanFormService {
    ...
    /**
     * Get changes for a WAN form
     * Get the changes for a WAN form
     * @param requestParameters
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public getWanFormChangesWanForm(requestParameters: GetWanFormChangesWanFormRequestParams, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<WanFormChanges>;
    public getWanFormChangesWanForm(requestParameters: GetWanFormChangesWanFormRequestParams, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<WanFormChanges>>;
    public getWanFormChangesWanForm(requestParameters: GetWanFormChangesWanFormRequestParams, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<WanFormChanges>>;
    public getWanFormChangesWanForm(requestParameters: GetWanFormChangesWanFormRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        const id = requestParameters.id;
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling getWanFormChangesWanForm.');
        }
        ...
        return this.httpClient.get<WanFormChanges>(`${this.configuration.basePath}/v1/network-scope-forms/wan-form/${encodeURIComponent(String(id))}/changes`,
            {
                responseType: <any>responseType,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
