...
export class V2AppCentricRouteProfilesService {
     ...
     */
    public createManyRouteProfile(requestParameters: CreateManyRouteProfileRequestParams, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<Array<RouteProfile>>;
    public createManyRouteProfile(requestParameters: CreateManyRouteProfileRequestParams, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<Array<RouteProfile>>>;
    public createManyRouteProfile(requestParameters: CreateManyRouteProfileRequestParams, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<Array<RouteProfile>>>;
    public createManyRouteProfile(requestParameters: CreateManyRouteProfileRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        ...
        return this.httpClient.post<Array<RouteProfile>>(`${this.configuration.basePath}/v2/app-centric/route-profiles/bulk`,
