...
export class V2AppCentricAppCentricSubnetsService {
     ...
     */
    public createManyAppCentricSubnet(requestParameters: CreateManyAppCentricSubnetRequestParams, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<Array<AppCentricSubnet>>;
    public createManyAppCentricSubnet(requestParameters: CreateManyAppCentricSubnetRequestParams, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<Array<AppCentricSubnet>>>;
    public createManyAppCentricSubnet(requestParameters: CreateManyAppCentricSubnetRequestParams, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<Array<AppCentricSubnet>>>;
    public createManyAppCentricSubnet(requestParameters: CreateManyAppCentricSubnetRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        ...
        return this.httpClient.post<Array<AppCentricSubnet>>(`${this.configuration.basePath}/v2/app-centric/app-centric-subnets/bulk`,
