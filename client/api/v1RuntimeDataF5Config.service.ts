...
export class V1RuntimeDataF5ConfigService {
    ...
    /**
     * Create Runtime Data F5 Config Collection Job
     * @param requestParameters
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public createRuntimeDataJobF5Config(requestParameters: CreateRuntimeDataJobF5ConfigRequestParams, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<Job>;
    public createRuntimeDataJobF5Config(requestParameters: CreateRuntimeDataJobF5ConfigRequestParams, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<Job>>;
    public createRuntimeDataJobF5Config(requestParameters: CreateRuntimeDataJobF5ConfigRequestParams, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<Job>>;
    public createRuntimeDataJobF5Config(requestParameters: CreateRuntimeDataJobF5ConfigRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        const f5ConfigJobCreateDto = requestParameters.f5ConfigJobCreateDto;
        if (f5ConfigJobCreateDto === null || f5ConfigJobCreateDto === undefined) {
            throw new Error('Required parameter f5ConfigJobCreateDto was null or undefined when calling createRuntimeDataJobF5Config.');
        }
        ...
        return this.httpClient.post<Job>(`${this.configuration.basePath}/v1/runtime-data/f5-config/create-runtime-data-job`,
