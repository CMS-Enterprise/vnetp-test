...
export interface WanFormChangesInternalRouteDto { 
    /**
     * The ID of the internal route
     */
    id: string;
    /**
     * The network of the internal route
     */
    network: string;
    /**
     * The VRFs that the internal route is exported to
     */
    exportedToVrfs: Array<WanFormChangesInternalRouteDtoExportedToVrfsEnum>;
    /**
     * The timestamp of the internal route
     */
    timestamp: string;
}
export enum WanFormChangesInternalRouteDtoExportedToVrfsEnum {
