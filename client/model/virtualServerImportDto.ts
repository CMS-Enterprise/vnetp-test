...
export interface VirtualServerImportDto { 
    ...
    sourceAddressTranslation: VirtualServerImportDtoSourceAddressTranslationEnum;
...
export enum VirtualServerImportDtoSourceAddressTranslationEnum {
    None = 'None',
    AutoMap = 'AutoMap',
    Snat = 'SNAT'
};
export enum VirtualServerImportDtoTypeEnum {
    Standard = 'Standard'
};
