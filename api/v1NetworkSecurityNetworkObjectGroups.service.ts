...
export class V1NetworkSecurityNetworkObjectGroupsService {
   ...
   * @param networkObjectGroupId Network Object Group that the Network Object is being added to/removed from.
   * @param networkObjectId Network Object that is being added or removed from group membership.
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
