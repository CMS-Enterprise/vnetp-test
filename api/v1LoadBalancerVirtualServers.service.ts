...
export class V1LoadBalancerVirtualServersService {
  ...
  public v1LoadBalancerVirtualServersBulkPost(
    ...
    if (
      ...
      throw new Error(
        'Required parameter generatedLoadBalancerVirtualServerBulkDto was null or undefined when calling v1LoadBalancerVirtualServersBulkPost.',
      );
    }
    ...
    return this.httpClient.post<Array<LoadBalancerVirtualServer>>(
      `${this.configuration.basePath}/v1/load-balancer/virtual-servers/bulk`,
  ...
  public v1LoadBalancerVirtualServersGet(
    ...
    return this.httpClient.get<Array<LoadBalancerVirtualServer>>(
      `${this.configuration.basePath}/v1/load-balancer/virtual-servers`,
      {
  ...
  public v1LoadBalancerVirtualServersIdDelete(
    ...
    return this.httpClient.delete<LoadBalancerVirtualServer>(
      `${
        this.configuration.basePath
      }/v1/load-balancer/virtual-servers/${encodeURIComponent(String(id))}`,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
        observe: observe,
  ...
  public v1LoadBalancerVirtualServersIdDeprovisionPatch(
    ...
    return this.httpClient.patch<any>(
      `${
        this.configuration.basePath
      }/v1/load-balancer/virtual-servers/${encodeURIComponent(
        String(id),
      )}/deprovision`,
      null,
      {
  ...
  public v1LoadBalancerVirtualServersIdGet(
    ...
    return this.httpClient.get<LoadBalancerVirtualServer>(
      `${
        this.configuration.basePath
      }/v1/load-balancer/virtual-servers/${encodeURIComponent(String(id))}`,
      {
  ...
  public v1LoadBalancerVirtualServersIdPatch(
    ...
    if (
      ...
      throw new Error(
        'Required parameter loadBalancerVirtualServer was null or undefined when calling v1LoadBalancerVirtualServersIdPatch.',
      );
    }
    ...
    return this.httpClient.patch<LoadBalancerVirtualServer>(
      `${
        this.configuration.basePath
      }/v1/load-balancer/virtual-servers/${encodeURIComponent(String(id))}`,
  ...
  public v1LoadBalancerVirtualServersIdPut(
    ...
    if (
      ...
      throw new Error(
        'Required parameter loadBalancerVirtualServer was null or undefined when calling v1LoadBalancerVirtualServersIdPut.',
      );
    }
    ...
    return this.httpClient.put<LoadBalancerVirtualServer>(
      `${
        this.configuration.basePath
      }/v1/load-balancer/virtual-servers/${encodeURIComponent(String(id))}`,
      loadBalancerVirtualServer,
  ...
  public v1LoadBalancerVirtualServersPost(
    ...
    if (
      ...
      throw new Error(
        'Required parameter loadBalancerVirtualServer was null or undefined when calling v1LoadBalancerVirtualServersPost.',
      );
    }
    ...
    return this.httpClient.post<LoadBalancerVirtualServer>(
      `${this.configuration.basePath}/v1/load-balancer/virtual-servers`,
      loadBalancerVirtualServer,
      {
        withCredentials: this.configuration.withCredentials,
